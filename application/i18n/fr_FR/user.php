...
$lang = array (
	'form' => array(
		'username' => 'Pseudo',
		'password0' => 'Mot de passe',
		'password' => 'Mot de passe actuel',
		'password_new' => 'Nouveau mot de passe',
		'password_again' => 'Retaper à nouveau',
		'email' => 'E-mail',
		'gender' => 'Genre',
		'birthday' => 'Date de naissance',
		'image' => 'Avatar utilisé',
		'locale' => 'Langue par défaut',
		'notif_forum' => 'Notifications du forum',
		'api' => 'Clé API (développeur)'
	),
	'gender' => array(
		'unknown' => 'Inconnu(e)',
		'man' => 'Masculin',
	...
	'view' => array(
		...
		'prelude1' => "Voici votre profil complet et détaillé. Vous y trouverez toutes les informations relatives à votre compte. Vous avez aussi la possibilité de publier des informations personnelles ou encore de cacher certaines autres. Personnalisez cette page en y ajoutant également un avatar ou encore une description de vous.",
		'prelude2' => "Voici le profil complet et détaillé d'un user. Vous y trouverez toutes les informations relatives à son compte, au niveau du jeu, mais aussi quelques informations personelles, s'il a néanmoins rempli les champs concernés."
	),
	'edit' => array(
	...
	'lost' => array(
		...
		'prelude1' => "Comment ça vous avez perdu votre mot de passe, coubo? Ce n'est pas possible ça! Vous avez aussi regardé vos mails? Vos informations de connexion vous sont envoyés à votre inscription et à chaque fois que vous en changez! Ah moins que vous avez aussi perdu ces mails? Ok, ok, ne paniquez pas et remplissez plutôt ce formulaire pour en avoir un nouveau.",
